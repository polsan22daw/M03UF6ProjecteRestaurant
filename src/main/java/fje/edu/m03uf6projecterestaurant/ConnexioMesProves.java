...
public class ConnexioMesProves {
    ...
    public static Connection obtenirConnexioPrincipal() throws SQLException, IOException {
        ...
        FileInputStream in = new FileInputStream("C:\\Users\\angel\\Desktop\\DAW\\M03\\UF6\\M03UF6ProjecteRestaurant\\src\\main\\resources\\databaseBase.properties");
        props.load(in);
        in.close();
    ...
    public static Connection obtenirConnexio() throws SQLException, IOException {
        Properties props = new Properties();
        FileInputStream in = new FileInputStream("C:\\Users\\angel\\Desktop\\DAW\\M03\\UF6\\M03UF6ProjecteRestaurant\\src\\main\\resources\\database.properties");
        props.load(in);
        in.close();
